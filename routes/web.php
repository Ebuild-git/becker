...
//Route::get('/details-produits/{id}', [HomeController::class, 'details']) ->name('details-produits');
//Route::get('/details-devis/{id}', [HomeController::class, 'details-devis'])->name('details-devis');
...
Route::post('/notifications/mark-as-read', [NotificationController::class, 'markAsRead'])->name('mark_notifications_as_read');
// routes/web.php
//Route::get('/admin/notifications', [NotificationController::class, 'index'])->name('admin.notifications');
//Route::get('/notifications', [NotificationController::class, 'getNotifications'])->name('live_notifications');
Route::post('/notifications/mark-as-read', [NotificationController::class, 'markAsRead'])->name('mark_notifications_as_read');
