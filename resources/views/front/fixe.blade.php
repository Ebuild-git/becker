                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="#" onclick="openWishlist()">
                                        <i class="lni lni-heart"></i><span class="dn-counter"> @if (auth()->user())
                                ...
                                <li>
                                    <a href="#" onclick="openCart()">
                                        <i class="lni lni-shopping-basket"></i><span id="count-panier-span">0</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" id="password1" required type="password"
                                    value="{{ old('password') }}" name="password" placeholder="Votre mot de passe">
                                <span class="oeil">
                    ...
                    <form class="form m-0 p-0" role="search" action="{{ url('search') }}" method="get">
                        ...
                        <div class="form-group">
                            ...
                            <input id="search" type="search" name="search" class="form-control"
                                { value="{{ $nom ?? '' }}" placeholder="Rechercher un produit"
                                required>
